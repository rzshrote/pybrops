...
setwd("C:/Users/rs14/Documents/research/breeding_optimization/PyBrOpt/experiments/")

# load data frame
pts_df <- read.csv("paa_pad_1578330682.tsv", sep='\t', header=T)
...
sink("paa_pad_1578330682_lm.txt")
summary(paa_pad_lm)
...
# make plots
png("paa_pad_1578330682_lm1.png", width=700, height=700)
with(pts_df, plot(paa, pad, xlab="PAA", ylab="PAD", main="PAA vs PAD", pch=3))
abline(paa_pad_lm, col="red", lwd=2)
mtext(paa_pad_eq)
dev.off()
png("paa_pad_1578330682_lm2.png", width=700, height=700)
...
dev.off()
png("paa_pad_1578330682_lm3.png", width=700, height=700)
