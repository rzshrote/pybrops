...
from pybrops.model.embvmat.ExpectedMaximumBreedingValueMatrix import check_is_ExpectedMaximumBreedingValueMatrix
...
@pytest.fixture
def embvmat():
    out = DummyExpectedMaximumBreedingValueMatrix()
    yield out

################################################################################
########################## Test module documentation ###########################
################################################################################
def test_ExpectedMaximumBreedingValueMatrix_module_documentation():
    import pybrops.model.embvmat.ExpectedMaximumBreedingValueMatrix
    assert_module_documentation(pybrops.model.embvmat.ExpectedMaximumBreedingValueMatrix)

def test_ExpectedMaximumBreedingValueMatrix_module_public_api():
    import pybrops.model.embvmat.ExpectedMaximumBreedingValueMatrix
    assert_module_public_api(pybrops.model.embvmat.ExpectedMaximumBreedingValueMatrix)

################################################################################
########################### Test class documentation ###########################
################################################################################
def test_ExpectedMaximumBreedingValueMatrix_is_abstract():
    assert_class_isabstract(ExpectedMaximumBreedingValueMatrix)
...
def test_from_gmod_is_abstract():
    assert_classmethod_isabstract(ExpectedMaximumBreedingValueMatrix, "from_gmod")
...
def test_check_is_ExpectedMaximumBreedingValueMatrix_is_concrete():
    assert_function_isconcrete(check_is_ExpectedMaximumBreedingValueMatrix)

def test_check_is_ExpectedMaximumBreedingValueMatrix(embvmat):
    with not_raises(TypeError):
        check_is_ExpectedMaximumBreedingValueMatrix(embvmat, "embvmat")
    with pytest.raises(TypeError):
        check_is_ExpectedMaximumBreedingValueMatrix(None, "embvmat")