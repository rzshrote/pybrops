...
class DummyUsefulnessCriterionMatrix(UsefulnessCriterionMatrix):
    ################### Special methods ####################
    ...
    @nsquare_taxa.setter
    def nsquare_taxa(self, value: object) -> None:
        super().nsquare_taxa = value
    @property
    ...
    @square_taxa_axes.setter
    def square_taxa_axes(self, value: object) -> None:
        super().square_taxa_axes = value
    @property
    def square_taxa_axes_len(self) -> object:
        return super().square_taxa_axes_len
    @square_taxa_axes_len.setter
    def square_taxa_axes_len(self, value: object) -> None:
        super().square_taxa_axes_len = value
    @property
    def upper_percentile(self) -> object:
        return super().upper_percentile
    @property
    def selection_intensity(self) -> object:
        return super().selection_intensity
    ####################### Methods ########################
    ...
    @classmethod
    def from_gmod(cls, gmod: GenomicModel, pgmat: PhasedGenotypeMatrix, nmating: int, nprogeny: int, nself: int, gmapfn: GeneticMapFunction, **kwargs: dict) -> UsefulnessCriterionMatrix:
        return super().from_gmod(gmod, pgmat, nmating, nprogeny, nself, gmapfn, **kwargs)

class DummyAdditiveUsefulnessCriterionMatrix(DummyUsefulnessCriterionMatrix,AdditiveUsefulnessCriterionMatrix):
    @classmethod
    def from_algmod(cls, algmod: AdditiveLinearGenomicModel, pgmat: PhasedGenotypeMatrix, nmating: int, nprogeny: int, nself: int, gmapfn: GeneticMapFunction, mem: int, **kwargs: dict) -> AdditiveUsefulnessCriterionMatrix:
        return super().from_algmod(algmod, pgmat, nmating, nprogeny, nself, gmapfn, mem, **kwargs)
