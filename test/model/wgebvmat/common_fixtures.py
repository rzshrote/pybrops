...
class DummyWeightedGenomicEstimatedBreedingValueMatrix(WeightedGenomicEstimatedBreedingValueMatrix):
    ...
    @classmethod
    def from_algmod(cls, algmod: AdditiveLinearGenomicModel, gmat: GenotypeMatrix, **kwargs: dict) -> WeightedGenomicEstimatedBreedingValueMatrix:
        return super().from_algmod(algmod, gmat, **kwargs)
