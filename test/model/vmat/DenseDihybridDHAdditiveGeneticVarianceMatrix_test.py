...
def test_class_docstring():
    assert_class_documentation(DenseDihybridDHAdditiveGeneticVarianceMatrix)

########################### Test concrete properties ###########################

### mat
def test_mat_is_concrete():
    assert_property_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "mat")
...
def test_square_axes_is_concrete():
    assert_property_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "square_axes")

### trait_axis
def test_trait_axis_is_concrete():
    assert_property_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "trait_axis")

### epgc
def test_epgc_is_concrete():
    assert_property_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "epgc")

### nfemale
def test_nfemale_is_concrete():
    assert_property_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "nfemale")

### female_axis
def test_female_axis_is_concrete():
    assert_property_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "female_axis")

### nmale
def test_nmale_is_concrete():
    assert_property_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "nmale")

### male_axis
def test_male_axis_is_concrete():
    assert_property_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "male_axis")

############################# Test concrete methods ############################

### __init__
def test___init___is_concrete():
    assert_method_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "__init__")

### to_pandas
def test_to_pandas_is_concrete():
    assert_method_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "to_pandas")
...
def test_to_csv_is_concrete():
    assert_method_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "to_csv")
...
def test_to_hdf5_is_concrete():
    assert_method_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "to_hdf5")
...
def test_from_pandas_is_concrete():
    assert_classmethod_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "from_pandas")
...
def test_from_csv_is_concrete():
    assert_classmethod_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "from_csv")
...
def test_from_hdf5_is_concrete():
    assert_classmethod_isconcrete(DenseDihybridDHAdditiveGeneticVarianceMatrix, "from_hdf5")
