...
class DummyGeneticVarianceMatrix(GeneticVarianceMatrix):
    ...
    def adjoin_trait(self, values: Matrix | ndarray, trait: ndarray, **kwargs: dict) -> TraitMatrix:
    ...
    def append_trait(self, values: Matrix | ndarray, trait: ndarray, **kwargs: dict) -> None:
    ...
    def epgc(self) -> object:
        return super().epgc
    @epgc.setter
    def epgc(self, value: object) -> None:
        super().epgc = value
    @classmethod
    ...
    def incorp_trait(self, obj: int | slice | Sequence, values: Matrix | ndarray, trait: ndarray, **kwargs: dict) -> None:
    ...
    def insert_trait(self, obj: int | slice | Sequence, values: Matrix | ndarray, trait: ndarray, **kwargs) -> TraitMatrix:
    ...
    def lexsort_trait(self, keys: tuple | ndarray, **kwargs: dict) -> ndarray:
    ...
    def reorder_trait(self, indices: ndarray | Sequence, **kwargs: dict) -> None:
    ...
    def sort_trait(self, keys: tuple | ndarray, **kwargs: dict) -> None:
...
class DummyGenicVarianceMatrix(GenicVarianceMatrix):
    def __init__(self) -> None:
        pass
    def __add__(self, value):
        return super().__add__(value)
...
class DummyDenseGeneticVarianceMatrix(DenseGeneticVarianceMatrix):
    @classmethod
    def from_gmod(cls, gmod: GenomicModel, pgmat: PhasedGenotypeMatrix, ncross: int, nprogeny: int, nself: int, gmapfn: GeneticMapFunction, **kwargs: dict) -> GeneticVarianceMatrix:
        return super().from_gmod(gmod, pgmat, ncross, nprogeny, nself, gmapfn, **kwargs)
    def to_csv(self, filename: str) -> None:
