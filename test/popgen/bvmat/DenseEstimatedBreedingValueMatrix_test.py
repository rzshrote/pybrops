...
def test_class_docstring():
    assert_class_documentation(DenseEstimatedBreedingValueMatrix)

################################################################################
############################# Test concrete methods ############################
################################################################################
def test_init_is_concrete():
    assert_method_isconcrete(DenseEstimatedBreedingValueMatrix, "__init__")
...
def test_check_is_DenseEstimatedBreedingValueMatrix_is_concrete():
    assert_function_isconcrete(check_is_DenseEstimatedBreedingValueMatrix)
