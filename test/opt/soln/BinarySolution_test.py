...
def test_BinarySolution_docstring():
    assert_docstring(BinarySolution)
...
def test_decn_space_is_concrete():
    assert_concrete_property(BinarySolution, "decn_space")
...
def test_init_is_concrete():
    assert_concrete_method(BinarySolution, "__init__")
...
def test_check_is_BinarySolution_is_concrete():
    assert_concrete_function(check_is_BinarySolution)
