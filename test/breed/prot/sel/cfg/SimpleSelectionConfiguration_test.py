...
def test_SimpleSelectionConfiguration_is_semiabstract():
    assert_concrete_class(SimpleSelectionConfiguration)

############################## Test class docstring ############################
def test_SimpleSelectionConfiguration_docstring():
    assert_docstring(SimpleSelectionConfiguration)

############################# Test class properties ############################

### __init__ ###
def test_SimpleSelectionConfiguration_init_is_concrete():
    assert_concrete_property(SimpleSelectionConfiguration, "__init__")
