...
def test_class_docstring():
    assert_class_documentation(RandomIntegerSelection)

############################# Test concrete methods ############################
def test___init___is_concrete():
    assert_method_isconcrete(RandomIntegerSelection, "__init__")

def test_problem_is_concrete():
    assert_method_isconcrete(RandomIntegerSelection, "problem")

def test_sosolve_is_concrete():
    assert_method_isconcrete(RandomIntegerSelection, "sosolve")

def test_mosolve_is_concrete():
    assert_method_isconcrete(RandomIntegerSelection, "mosolve")

def test_select_is_concrete():
    assert_method_isconcrete(RandomIntegerSelection, "select")
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/RandomIntegerSelection_2d_frontier.png", dpi = 250)
    pyplot.close()
