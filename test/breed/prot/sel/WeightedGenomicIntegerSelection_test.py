...
def test_problem_is_concrete():
    assert_method_isconcrete(WeightedGenomicIntegerSelection, "problem")

def test_sosolve_is_concrete():
    assert_method_isconcrete(WeightedGenomicIntegerSelection, "sosolve")

def test_mosolve_is_concrete():
    assert_method_isconcrete(WeightedGenomicIntegerSelection, "mosolve")

def test_select_is_concrete():
    assert_method_isconcrete(WeightedGenomicIntegerSelection, "select")
