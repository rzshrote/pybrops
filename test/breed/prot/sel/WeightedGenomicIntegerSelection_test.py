...
def selprot_single(
    ...
    out = WeightedGenomicIntegerSelection(
...
def test_class_docstring():
    assert_docstring(WeightedGenomicIntegerSelection)

############################# Test concrete methods ############################
def test_init_is_concrete():
    assert_concrete_method(WeightedGenomicIntegerSelection, "__init__")

def test_problem_is_concrete():
    assert_concrete_method(WeightedGenomicIntegerSelection, "problem")

def test_sosolve_is_concrete():
    assert_concrete_method(WeightedGenomicIntegerSelection, "sosolve")

def test_mosolve_is_concrete():
    assert_concrete_method(WeightedGenomicIntegerSelection, "mosolve")

def test_select_is_concrete():
    assert_concrete_method(WeightedGenomicIntegerSelection, "select")
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/WeightedGenomicIntegerSelection_2d_frontier.png", dpi = 250)
    pyplot.close()
