...
from pybrops.breed.prot.sel.TwoWayParentalMeanEstimatedBreedingValueSelection import TwoWayParentalMeanEstimatedBreedingValueSubsetSelection
...
def selprob(
    ...
    out = TwoWayParentalMeanEstimatedBreedingValueSubsetMateSelectionProblem.from_bvmat_xmap(
        bvmat = algmod.gebv(gmat),
        xmap = selprob_xmap,
...
def selprot(
    ...
    out = TwoWayParentalMeanEstimatedBreedingValueSubsetSelection(
        ntrait = ntrait,
        unscale = True,
        symab = True,
        mateab = "uniq",
...
def test___init___is_concrete():
    assert_method_isconcrete(TwoWayParentalMeanEstimatedBreedingValueSubsetSelection, "__init__")

def test___init__(selprot):
    assert isinstance(selprot, TwoWayParentalMeanEstimatedBreedingValueSubsetSelection)
