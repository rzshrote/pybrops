...
def test_class_docstring():
    assert_class_documentation(ExpectedMaximumBreedingValueSubsetSelection)

############################# Test concrete methods ############################
def test_init_is_concrete():
    assert_method_isconcrete(ExpectedMaximumBreedingValueSubsetSelection, "__init__")

def test_problem_is_concrete():
    assert_method_isconcrete(ExpectedMaximumBreedingValueSubsetSelection, "problem")

def test_sosolve_is_concrete():
    assert_method_isconcrete(ExpectedMaximumBreedingValueSubsetSelection, "sosolve")

def test_mosolve_is_concrete():
    assert_method_isconcrete(ExpectedMaximumBreedingValueSubsetSelection, "mosolve")

def test_select_is_concrete():
    assert_method_isconcrete(ExpectedMaximumBreedingValueSubsetSelection, "select")
