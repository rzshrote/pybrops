...
def selprot_single(
    ...
    out = WeightedGenomicSubsetSelection(
...
def test_class_docstring():
    assert_class_documentation(WeightedGenomicSubsetSelection)

############################# Test concrete methods ############################
def test_init_is_concrete():
    assert_method_isconcrete(WeightedGenomicSubsetSelection, "__init__")

def test_problem_is_concrete():
    assert_method_isconcrete(WeightedGenomicSubsetSelection, "problem")

def test_sosolve_is_concrete():
    assert_method_isconcrete(WeightedGenomicSubsetSelection, "sosolve")

def test_mosolve_is_concrete():
    assert_method_isconcrete(WeightedGenomicSubsetSelection, "mosolve")

def test_select_is_concrete():
    assert_method_isconcrete(WeightedGenomicSubsetSelection, "select")
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/WeightedGenomicSubsetSelection_2d_frontier.png", dpi = 250)
    pyplot.close()
