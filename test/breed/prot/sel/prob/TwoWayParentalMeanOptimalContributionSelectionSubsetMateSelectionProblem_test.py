...
@pytest.fixture
def selprob_xcontrib(ntaxa, selprob_symab, selprob_mateab):
    out = numpy.random.random((twowayix_len(ntaxa, selprob_symab, selprob_mateab),2))
    return out
...
@pytest.fixture
def selprob_cmatfcty():
    out = DenseMolecularCoancestryMatrixFactory()
    return out
