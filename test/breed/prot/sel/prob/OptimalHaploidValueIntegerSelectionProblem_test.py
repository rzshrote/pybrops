...
def prob(
    ...
    yield OptimalHaploidValueIntegerSelectionProblem(
        ohvmat = ohvmat,
        ndecn = ndecn,
...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_class_documentation(OptimalHaploidValueIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(OptimalHaploidValueIntegerSelectionProblem, "nlatent")
...
def test_ohvmat_is_concrete():
    assert_property_isconcrete(OptimalHaploidValueIntegerSelectionProblem, "ohvmat")
...
def test_init_is_concrete():
    assert_method_isconcrete(OptimalHaploidValueIntegerSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(OptimalHaploidValueIntegerSelectionProblem, "latentfn")
...
def test_from_pgmat_gpmod(
    ...
    # construct problem
    ohvprob = OptimalHaploidValueIntegerSelectionProblem.from_pgmat_gpmod(
        nparent, nhaploblk, unique_parents, pgmat, gpmod,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
