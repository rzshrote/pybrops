...
def prob(
    ...
    yield UsefulnessCriterionRealMateSelectionProblem(
        ucmat = ucmat,
        ndecn = ndecn,
...
def test_RealConventionalSelectionProblem_docstring():
    assert_class_documentation(UsefulnessCriterionRealMateSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(UsefulnessCriterionRealMateSelectionProblem, "nlatent")
...
def test_ucmat_is_concrete():
    assert_property_isconcrete(UsefulnessCriterionRealMateSelectionProblem, "ucmat")
...
def test___init___is_concrete():
    assert_method_isconcrete(UsefulnessCriterionRealMateSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(UsefulnessCriterionRealMateSelectionProblem, "latentfn")
...
def test_from_pgmat_gpmod(
    ...
    # construct problem
    ohvprob = UsefulnessCriterionRealMateSelectionProblem.from_pgmat_gpmod(
        nparent, ncross, nprogeny, nself, upper_percentile, vmatfcty, gmapfn, unique_parents, pgmat, gpmod,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
