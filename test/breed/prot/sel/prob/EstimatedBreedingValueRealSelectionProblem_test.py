...
def prob(
    ...
    yield EstimatedBreedingValueRealSelectionProblem(
        ebv = ebv,
        ndecn = ndecn,
...
def test_RealConventionalSelectionProblem_docstring():
    assert_class_documentation(EstimatedBreedingValueRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(EstimatedBreedingValueRealSelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_property_isconcrete(EstimatedBreedingValueRealSelectionProblem, "ebv")
...
def test___init___is_concrete():
    assert_method_isconcrete(EstimatedBreedingValueRealSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(EstimatedBreedingValueRealSelectionProblem, "latentfn")
