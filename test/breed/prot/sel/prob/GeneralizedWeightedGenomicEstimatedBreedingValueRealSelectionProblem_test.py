...
def prob(
    ...
    yield GeneralizedWeightedGenomicEstimatedBreedingValueRealSelectionProblem(
        gwgebv = gwgebv,
        ndecn = ndecn,
...
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(GeneralizedWeightedGenomicEstimatedBreedingValueRealSelectionProblem, "latentfn")
...
def test_from_numpy(
    ...
    # construct problem
    gebvprob = GeneralizedWeightedGenomicEstimatedBreedingValueRealSelectionProblem.from_numpy(
...
def test_from_gmat_algpmod(
    ...
    gwgebv = Z_a.dot(u_a * numpy.power(fafreq, -alpha))
    # construct problem
    gebvprob = GeneralizedWeightedGenomicEstimatedBreedingValueRealSelectionProblem.from_gmat_algpmod(
        gmat, gpmod, alpha,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
