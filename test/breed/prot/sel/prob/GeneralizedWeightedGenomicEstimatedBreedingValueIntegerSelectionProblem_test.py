...
def prob(
    ...
    yield GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem(
        gwgebv = gwgebv,
        ndecn = ndecn,
...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_class_documentation(GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem, "nlatent")
...
def test_gwgebv_is_concrete():
    assert_property_isconcrete(GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem, "gwgebv")
...
def test_init_is_concrete():
    assert_method_isconcrete(GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem, "latentfn")
...
def test_from_numpy(
    ...
    # construct problem
    gebvprob = GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem.from_numpy(
...
def test_from_gmat_algpmod(
    ...
    gwgebv = Z_a.dot(u_a * numpy.power(fafreq, -alpha))
    # construct problem
    gebvprob = GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem.from_gmat_algpmod(
        gmat, gpmod, alpha,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
