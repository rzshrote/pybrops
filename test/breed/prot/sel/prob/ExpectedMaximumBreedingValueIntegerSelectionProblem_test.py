...
def prob(
    ...
    yield ExpectedMaximumBreedingValueIntegerSelectionProblem(
        embv = embv,
        ndecn = ndecn,
...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_class_documentation(ExpectedMaximumBreedingValueIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(ExpectedMaximumBreedingValueIntegerSelectionProblem, "nlatent")
...
def test_embv_is_concrete():
    assert_property_isconcrete(ExpectedMaximumBreedingValueIntegerSelectionProblem, "embv")
...
def test___init___is_concrete():
    assert_method_isconcrete(ExpectedMaximumBreedingValueIntegerSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(ExpectedMaximumBreedingValueIntegerSelectionProblem, "latentfn")
...
def test_from_pgmat_gpmod(
    ...
    # construct problem
    gebvprob = ExpectedMaximumBreedingValueIntegerSelectionProblem.from_pgmat_gpmod(
        nparent, ncross, nprogeny, nrep, unique_parents, pgmat, gpmod, mateprot,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
