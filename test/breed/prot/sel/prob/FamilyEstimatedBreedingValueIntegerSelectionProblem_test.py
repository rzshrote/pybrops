...
def prob(
    ...
    yield FamilyEstimatedBreedingValueIntegerSelectionProblem(
        ebv = ebv,
        familyid = familyid,
        ndecn = ndecn,
...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_class_documentation(FamilyEstimatedBreedingValueIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(FamilyEstimatedBreedingValueIntegerSelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_property_isconcrete(FamilyEstimatedBreedingValueIntegerSelectionProblem, "ebv")
...
def test_init_is_concrete():
    assert_method_isconcrete(FamilyEstimatedBreedingValueIntegerSelectionProblem, "__init__")
...
def test_from_bvmat(
    ...
    # construct problem
    ebvprob = FamilyEstimatedBreedingValueIntegerSelectionProblem.from_bvmat(
        bvmat, 
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
