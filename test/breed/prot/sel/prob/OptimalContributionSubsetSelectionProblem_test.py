...
def prob(
    ...
    yield OptimalContributionSubsetSelectionProblem(
        ebv = ebv,
        C = C,
        ndecn = ndecn,
...
def test_SubsetConventionalSelectionProblem_docstring():
    assert_class_documentation(OptimalContributionSubsetSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(OptimalContributionSubsetSelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_property_isconcrete(OptimalContributionSubsetSelectionProblem, "ebv")
...
def test_C_is_concrete():
    assert_property_isconcrete(OptimalContributionSubsetSelectionProblem, "C")
...
def test___init___is_concrete():
    assert_method_isconcrete(OptimalContributionSubsetSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(OptimalContributionSubsetSelectionProblem, "latentfn")
...
def test_from_bvmat_gmat(
    ...
    # construct problem
    ocsprob = OptimalContributionSubsetSelectionProblem.from_bvmat_gmat(
        bvmat, gmat, cmatfcty, unscale,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
