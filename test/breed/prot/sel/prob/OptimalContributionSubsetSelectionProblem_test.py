...
def test_SubsetConventionalSelectionProblem_docstring():
    assert_docstring(OptimalContributionSubsetSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(OptimalContributionSubsetSelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_concrete_property(OptimalContributionSubsetSelectionProblem, "ebv")
...
def test_C_is_concrete():
    assert_concrete_property(OptimalContributionSubsetSelectionProblem, "C")
...
def test_init_is_concrete():
    assert_concrete_method(OptimalContributionSubsetSelectionProblem, "__init__")
