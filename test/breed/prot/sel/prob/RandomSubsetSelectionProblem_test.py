...
def prob(
    ...
    yield RandomSubsetSelectionProblem(
        rbv = rbv,
        ndecn = ndecn,
...
def test_SubsetConventionalSelectionProblem_docstring():
    assert_class_documentation(RandomSubsetSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(RandomSubsetSelectionProblem, "nlatent")
...
def test_rbv_is_concrete():
    assert_property_isconcrete(RandomSubsetSelectionProblem, "rbv")
...
def test___init___is_concrete():
    assert_method_isconcrete(RandomSubsetSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(RandomSubsetSelectionProblem, "latentfn")

def test_latentfn(prob, ntaxa, rbv):
...
def test_from_object(
    ...
    # construct problem
    rbvprob = RandomSubsetSelectionProblem.from_object(
        ntaxa, ntrait,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
