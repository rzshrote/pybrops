...
def test_SubsetConventionalSelectionProblem_docstring():
    assert_docstring(RandomSubsetSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(RandomSubsetSelectionProblem, "nlatent")
...
def test_rbv_is_concrete():
    assert_concrete_property(RandomSubsetSelectionProblem, "rbv")
...
def test_init_is_concrete():
    assert_concrete_method(RandomSubsetSelectionProblem, "__init__")
