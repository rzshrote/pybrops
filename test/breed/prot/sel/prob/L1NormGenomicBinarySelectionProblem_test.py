...
def test_BinaryConventionalSelectionProblem_docstring():
    assert_docstring(L1NormGenomicBinarySelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(L1NormGenomicBinarySelectionProblem, "nlatent")
...
def test_V_is_concrete():
    assert_concrete_property(L1NormGenomicBinarySelectionProblem, "V")
...
def test_init_is_concrete():
    assert_concrete_method(L1NormGenomicBinarySelectionProblem, "__init__")
