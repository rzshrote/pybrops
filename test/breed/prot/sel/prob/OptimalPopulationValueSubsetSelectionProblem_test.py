...
def test_SubsetConventionalSelectionProblem_docstring():
    assert_class_documentation(OptimalPopulationValueSubsetSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(OptimalPopulationValueSubsetSelectionProblem, "nlatent")
...
def test_haplomat_is_concrete():
    assert_property_isconcrete(OptimalPopulationValueSubsetSelectionProblem, "haplomat")
...
def test___init___is_concrete():
    assert_method_isconcrete(OptimalPopulationValueSubsetSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(OptimalPopulationValueSubsetSelectionProblem, "latentfn")
