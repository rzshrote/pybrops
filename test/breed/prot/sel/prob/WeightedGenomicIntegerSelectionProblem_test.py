...
from pybrops.breed.prot.sel.prob.WeightedGenomicSelectionProblem import WeightedGenomicIntegerSelectionProblem
...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_class_documentation(WeightedGenomicIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(WeightedGenomicIntegerSelectionProblem, "nlatent")
...
def test_gwgebv_is_concrete():
    assert_property_isconcrete(WeightedGenomicIntegerSelectionProblem, "gwgebv")
...
def test___init___is_concrete():
    assert_method_isconcrete(WeightedGenomicIntegerSelectionProblem, "__init__")
...
def test_from_numpy(
    ...
    # construct problem
    gebvprob = WeightedGenomicIntegerSelectionProblem.from_numpy(
        Z_a, u_a, fafreq,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
...
def test_from_gmat_algpmod(
    ...
    gwgebv = Z_a.dot(u_a * numpy.power(fafreq, -0.5))
    # construct problem
    gebvprob = WeightedGenomicIntegerSelectionProblem.from_gmat_algpmod(
        gmat, gpmod,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
