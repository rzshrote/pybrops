...
def prob(
    ...
    yield OptimalContributionBinarySelectionProblem(
        ebv = ebv,
        C = C,
        ndecn = ndecn,
...
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(OptimalContributionBinarySelectionProblem, "latentfn")
...
def test_from_bvmat_gmat(
    ...
    # construct problem
    ocsprob = OptimalContributionBinarySelectionProblem.from_bvmat_gmat(
        bvmat, gmat, cmatfcty, unscale,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
