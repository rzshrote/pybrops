...
def prob(
    ...
    yield MeanExpectedHeterozygosityBinarySelectionProblem(
        C = C,
        ndecn = ndecn,
...
def test_BinaryConventionalSelectionProblem_docstring():
    assert_class_documentation(MeanExpectedHeterozygosityBinarySelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(MeanExpectedHeterozygosityBinarySelectionProblem, "nlatent")
...
def test_C_is_concrete():
    assert_property_isconcrete(MeanExpectedHeterozygosityBinarySelectionProblem, "C")
...
def test___init___is_concrete():
    assert_method_isconcrete(MeanExpectedHeterozygosityBinarySelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(MeanExpectedHeterozygosityBinarySelectionProblem, "latentfn")
...
def test_from_gmat(
    ...
    # construct problem
    ocsprob = MeanExpectedHeterozygosityBinarySelectionProblem.from_gmat(
        gmat, cmatfcty,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
