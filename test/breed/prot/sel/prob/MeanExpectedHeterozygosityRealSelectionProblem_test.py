...
def prob(
    ...
    yield MeanExpectedHeterozygosityRealSelectionProblem(
        C = C,
        ndecn = ndecn,
...
def test_RealConventionalSelectionProblem_docstring():
    assert_class_documentation(MeanExpectedHeterozygosityRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(MeanExpectedHeterozygosityRealSelectionProblem, "nlatent")
...
def test_C_is_concrete():
    assert_property_isconcrete(MeanExpectedHeterozygosityRealSelectionProblem, "C")
...
def test_init_is_concrete():
    assert_method_isconcrete(MeanExpectedHeterozygosityRealSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(MeanExpectedHeterozygosityRealSelectionProblem, "latentfn")
...
def test_from_gmat(
    ...
    # construct problem
    ocsprob = MeanExpectedHeterozygosityRealSelectionProblem.from_gmat(
        gmat, cmatfcty,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
