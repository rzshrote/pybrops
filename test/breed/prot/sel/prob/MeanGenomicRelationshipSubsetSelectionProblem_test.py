...
def prob(
    ...
    yield MeanGenomicRelationshipSubsetSelectionProblem(
        C = C,
        ndecn = ndecn,
...
def test_SubsetConventionalSelectionProblem_docstring():
    assert_class_documentation(MeanGenomicRelationshipSubsetSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(MeanGenomicRelationshipSubsetSelectionProblem, "nlatent")
...
def test_C_is_concrete():
    assert_property_isconcrete(MeanGenomicRelationshipSubsetSelectionProblem, "C")
...
def test___init___is_concrete():
    assert_method_isconcrete(MeanGenomicRelationshipSubsetSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(MeanGenomicRelationshipSubsetSelectionProblem, "latentfn")
...
def test_from_gmat(
    ...
    # construct problem
    ocsprob = MeanGenomicRelationshipSubsetSelectionProblem.from_gmat(
        gmat, cmatfcty,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
