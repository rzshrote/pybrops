...
def test_BinaryConventionalSelectionProblem_docstring():
    assert_class_documentation(FamilyEstimatedBreedingValueBinarySelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(FamilyEstimatedBreedingValueBinarySelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_property_isconcrete(FamilyEstimatedBreedingValueBinarySelectionProblem, "ebv")
...
def test___init___is_concrete():
    assert_method_isconcrete(FamilyEstimatedBreedingValueBinarySelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(FamilyEstimatedBreedingValueBinarySelectionProblem, "latentfn")
