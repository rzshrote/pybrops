...
def test___init___is_concrete():
    assert_method_isconcrete(TwoWayParentalMeanGenomicEstimatedBreedingValueSubsetMateSelectionProblem, "__init__")

def test___init__(selprob):
    assert isinstance(selprob, TwoWayParentalMeanGenomicEstimatedBreedingValueSubsetMateSelectionProblem)
...
def test_latentfn_is_concrete():
    assert_method_isconcrete(TwoWayParentalMeanGenomicEstimatedBreedingValueSubsetMateSelectionProblem, "latentfn")
