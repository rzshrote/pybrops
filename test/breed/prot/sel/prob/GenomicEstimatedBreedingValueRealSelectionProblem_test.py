...
def prob(
    ...
    yield GenomicEstimatedBreedingValueRealSelectionProblem(
        gebv = gebv,
        ndecn = ndecn,
...
def test_RealConventionalSelectionProblem_docstring():
    assert_class_documentation(GenomicEstimatedBreedingValueRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(GenomicEstimatedBreedingValueRealSelectionProblem, "nlatent")
...
def test_gebv_is_concrete():
    assert_property_isconcrete(GenomicEstimatedBreedingValueRealSelectionProblem, "gebv")
...
def test_init_is_concrete():
    assert_method_isconcrete(GenomicEstimatedBreedingValueRealSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(GenomicEstimatedBreedingValueRealSelectionProblem, "latentfn")
...
def test_from_bvmat(
    ...
    # construct problem
    gebvprob = GenomicEstimatedBreedingValueRealSelectionProblem.from_bvmat(
        bvmat, unscale,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
...
def test_from_gmat_gpmod(
    ...
    # construct problem
    gebvprob = GenomicEstimatedBreedingValueRealSelectionProblem.from_gmat_gpmod(
        gmat, gpmod, unscale,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
