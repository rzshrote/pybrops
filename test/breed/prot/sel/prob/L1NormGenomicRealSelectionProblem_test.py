...
def test_RealConventionalSelectionProblem_docstring():
    assert_docstring(L1NormGenomicRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(L1NormGenomicRealSelectionProblem, "nlatent")
...
def test_V_is_concrete():
    assert_concrete_property(L1NormGenomicRealSelectionProblem, "V")
...
def test_init_is_concrete():
    assert_concrete_method(L1NormGenomicRealSelectionProblem, "__init__")
