...
def prob(
    ...
    yield FamilyEstimatedBreedingValueRealSelectionProblem(
        ebv = ebv,
        familyid = familyid,
        ndecn = ndecn,
...
def test_RealConventionalSelectionProblem_docstring():
    assert_class_documentation(FamilyEstimatedBreedingValueRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(FamilyEstimatedBreedingValueRealSelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_property_isconcrete(FamilyEstimatedBreedingValueRealSelectionProblem, "ebv")
...
def test_init_is_concrete():
    assert_method_isconcrete(FamilyEstimatedBreedingValueRealSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(FamilyEstimatedBreedingValueRealSelectionProblem, "latentfn")
...
def test_from_bvmat(
    ...
    # construct problem
    ebvprob = FamilyEstimatedBreedingValueRealSelectionProblem.from_bvmat(
        bvmat, 
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
