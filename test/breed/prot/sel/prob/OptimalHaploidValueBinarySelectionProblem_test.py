...
def test_BinaryConventionalSelectionProblem_docstring():
    assert_docstring(OptimalHaploidValueBinarySelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(OptimalHaploidValueBinarySelectionProblem, "nlatent")
...
def test_ohvmat_is_concrete():
    assert_concrete_property(OptimalHaploidValueBinarySelectionProblem, "ohvmat")
...
def test_init_is_concrete():
    assert_concrete_method(OptimalHaploidValueBinarySelectionProblem, "__init__")
