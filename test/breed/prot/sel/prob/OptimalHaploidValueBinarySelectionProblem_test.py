...
def prob(
    ...
    yield OptimalHaploidValueBinarySelectionProblem(
        ohvmat = ohvmat,
        ndecn = ndecn,
...
def test_BinaryConventionalSelectionProblem_docstring():
    assert_class_documentation(OptimalHaploidValueBinarySelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(OptimalHaploidValueBinarySelectionProblem, "nlatent")
...
def test_ohvmat_is_concrete():
    assert_property_isconcrete(OptimalHaploidValueBinarySelectionProblem, "ohvmat")
...
def test___init___is_concrete():
    assert_method_isconcrete(OptimalHaploidValueBinarySelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(OptimalHaploidValueBinarySelectionProblem, "latentfn")
...
def test_from_pgmat_gpmod(
    ...
    # construct problem
    ohvprob = OptimalHaploidValueBinarySelectionProblem.from_pgmat_gpmod(
        nparent, nhaploblk, unique_parents, pgmat, gpmod,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
