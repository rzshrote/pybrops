...
def prob(
    ...
    yield MeanGenomicRelationshipRealSelectionProblem(
        C = C,
        ndecn = ndecn,
...
def test_RealConventionalSelectionProblem_docstring():
    assert_class_documentation(MeanGenomicRelationshipRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(MeanGenomicRelationshipRealSelectionProblem, "nlatent")
...
def test_C_is_concrete():
    assert_property_isconcrete(MeanGenomicRelationshipRealSelectionProblem, "C")
...
def test_init_is_concrete():
    assert_method_isconcrete(MeanGenomicRelationshipRealSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(MeanGenomicRelationshipRealSelectionProblem, "latentfn")
...
def test_from_gmat(
    ...
    # construct problem
    ocsprob = MeanGenomicRelationshipRealSelectionProblem.from_gmat(
        gmat, cmatfcty,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
