...
def prob(
    ...
    yield OptimalHaploidValueRealSelectionProblem(
        ohvmat = ohvmat,
        ndecn = ndecn,
...
def test_RealConventionalSelectionProblem_docstring():
    assert_class_documentation(OptimalHaploidValueRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(OptimalHaploidValueRealSelectionProblem, "nlatent")
...
def test_ohvmat_is_concrete():
    assert_property_isconcrete(OptimalHaploidValueRealSelectionProblem, "ohvmat")
...
def test___init___is_concrete():
    assert_method_isconcrete(OptimalHaploidValueRealSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(OptimalHaploidValueRealSelectionProblem, "latentfn")
...
def test_from_pgmat_gpmod(
    ...
    # construct problem
    ohvprob = OptimalHaploidValueRealSelectionProblem.from_pgmat_gpmod(
        nparent, nhaploblk, unique_parents, pgmat, gpmod,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
