...
def test_IntegerSelectionProblem_docstring():
    assert_class_documentation(IntegerSelectionProblem)
...
def test___init___is_concrete():
    assert_method_isconcrete(IntegerSelectionProblem, "__init__")
...
def test_latentfn_is_abstract(prob):
    assert_method_isabstract(IntegerSelectionProblem, "latentfn")

################################################################################
######################### Test class utility functions #########################
################################################################################
def test_check_is_IntegerSelectionProblem_is_concrete():
    assert_function_isconcrete(check_is_IntegerSelectionProblem)
