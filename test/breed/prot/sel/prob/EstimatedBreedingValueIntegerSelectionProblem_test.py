...
def prob(
    ...
    yield EstimatedBreedingValueIntegerSelectionProblem(
        ebv = ebv,
        ndecn = ndecn,
...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_class_documentation(EstimatedBreedingValueIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(EstimatedBreedingValueIntegerSelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_property_isconcrete(EstimatedBreedingValueIntegerSelectionProblem, "ebv")
...
def test_init_is_concrete():
    assert_method_isconcrete(EstimatedBreedingValueIntegerSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(EstimatedBreedingValueIntegerSelectionProblem, "latentfn")
...
def test_from_bvmat(
    ...
    # construct problem
    ebvprob = EstimatedBreedingValueIntegerSelectionProblem.from_bvmat(
        bvmat, unscale,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
