...
def test_RealConventionalSelectionProblem_docstring():
    assert_docstring(WeightedGenomicRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(WeightedGenomicRealSelectionProblem, "nlatent")
...
def test_gwgebv_is_concrete():
    assert_concrete_property(WeightedGenomicRealSelectionProblem, "gwgebv")
...
def test_init_is_concrete():
    assert_concrete_method(WeightedGenomicRealSelectionProblem, "__init__")
