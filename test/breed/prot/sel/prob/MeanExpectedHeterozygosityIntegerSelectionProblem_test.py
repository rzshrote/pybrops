...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_class_documentation(MeanExpectedHeterozygosityIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(MeanExpectedHeterozygosityIntegerSelectionProblem, "nlatent")
...
def test_C_is_concrete():
    assert_property_isconcrete(MeanExpectedHeterozygosityIntegerSelectionProblem, "C")
...
def test_init_is_concrete():
    assert_method_isconcrete(MeanExpectedHeterozygosityIntegerSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(MeanExpectedHeterozygosityIntegerSelectionProblem, "latentfn")
