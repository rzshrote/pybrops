...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_class_documentation(UsefulnessCriterionIntegerMateSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_property_isconcrete(UsefulnessCriterionIntegerMateSelectionProblem, "nlatent")
...
def test_ucmat_is_concrete():
    assert_property_isconcrete(UsefulnessCriterionIntegerMateSelectionProblem, "ucmat")
...
def test___init___is_concrete():
    assert_method_isconcrete(UsefulnessCriterionIntegerMateSelectionProblem, "__init__")

################
### latentfn ###
################
def test_latentfn_is_concrete(prob):
    assert_method_isconcrete(UsefulnessCriterionIntegerMateSelectionProblem, "latentfn")
