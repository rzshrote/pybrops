...
from pybrops.breed.prot.sel.MeanGenomicRelationshipSelection import MeanGenomicRelationshipSubsetSelection
...
def selprot_single(
    ...
    out = MeanGenomicRelationshipSubsetSelection(
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/MeanGenomicRelationshipSubsetSelection_2d_frontier.png", dpi = 250)
    pyplot.close()
