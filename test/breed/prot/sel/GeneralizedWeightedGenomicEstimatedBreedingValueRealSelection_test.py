...
def selprot_single(
    ...
    out = GeneralizedWeightedGenomicEstimatedBreedingValueRealSelection(
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/GeneralizedWeightedGenomicEstimatedBreedingValueRealSelection_2d_frontier.png", dpi = 250)
    pyplot.close()
