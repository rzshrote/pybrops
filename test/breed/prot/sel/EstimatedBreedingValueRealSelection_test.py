...
def test_class_docstring():
    assert_class_documentation(EstimatedBreedingValueRealSelection)

############################# Test concrete methods ############################
def test___init___is_concrete():
    assert_method_isconcrete(EstimatedBreedingValueRealSelection, "__init__")

def test_problem_is_concrete():
    assert_method_isconcrete(EstimatedBreedingValueRealSelection, "problem")

def test_sosolve_is_concrete():
    assert_method_isconcrete(EstimatedBreedingValueRealSelection, "sosolve")

def test_mosolve_is_concrete():
    assert_method_isconcrete(EstimatedBreedingValueRealSelection, "mosolve")

def test_select_is_concrete():
    assert_method_isconcrete(EstimatedBreedingValueRealSelection, "select")
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/EstimatedBreedingValueRealSelection_2d_frontier.png", dpi = 250)
    pyplot.close()
