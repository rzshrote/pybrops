...
def selprot_single(
    ...
    out = OptimalHaploidValueBinarySelection(
...
def test_OptimalHaploidValueBinarySelection_is_concrete():
    assert_class_isconcrete(OptimalHaploidValueBinarySelection)

############################## Test class docstring ############################
def test_OptimalHaploidValueBinarySelection_docstring():
    assert_class_documentation(OptimalHaploidValueBinarySelection)

############################# Test concrete methods ############################

### __init__ ###
def test___init___is_concrete():
    assert_method_isconcrete(OptimalHaploidValueBinarySelection, "__init__")

### problem ###
def test_problem_is_concrete():
    assert_method_isconcrete(OptimalHaploidValueBinarySelection, "problem")
...
def test_sosolve_is_concrete():
    assert_method_isconcrete(OptimalHaploidValueBinarySelection, "sosolve")
...
def test_mosolve_is_concrete():
    assert_method_isconcrete(OptimalHaploidValueBinarySelection, "mosolve")
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/OptimalHaploidValueBinarySelection_2d_frontier.png", dpi = 250)
    pyplot.close()
...
def test_select_is_concrete():
    assert_method_isconcrete(OptimalHaploidValueBinarySelection, "select")
