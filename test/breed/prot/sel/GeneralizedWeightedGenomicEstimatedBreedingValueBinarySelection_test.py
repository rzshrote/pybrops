...
def selprot_single(
    ...
    out = GeneralizedWeightedGenomicEstimatedBreedingValueBinarySelection(
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/GeneralizedWeightedGenomicEstimatedBreedingValueBinarySelection_2d_frontier.png", dpi = 250)
    pyplot.close()
