...
from pybrops.breed.prot.sel.MeanExpectedHeterozygositySelection import MeanExpectedHeterozygosityRealSelection
...
def selprot_single(
    ...
    out = MeanExpectedHeterozygosityRealSelection(
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/MeanExpectedHeterozygosityRealSelection_2d_frontier.png", dpi = 250)
    pyplot.close()
