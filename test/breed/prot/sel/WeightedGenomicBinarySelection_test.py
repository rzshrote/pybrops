...
def selprot_single(
    ...
    out = WeightedGenomicBinarySelection(
...
def test_class_docstring():
    assert_class_documentation(WeightedGenomicBinarySelection)

############################# Test concrete methods ############################
def test___init___is_concrete():
    assert_method_isconcrete(WeightedGenomicBinarySelection, "__init__")

def test_problem_is_concrete():
    assert_method_isconcrete(WeightedGenomicBinarySelection, "problem")

def test_sosolve_is_concrete():
    assert_method_isconcrete(WeightedGenomicBinarySelection, "sosolve")

def test_mosolve_is_concrete():
    assert_method_isconcrete(WeightedGenomicBinarySelection, "mosolve")

def test_select_is_concrete():
    assert_method_isconcrete(WeightedGenomicBinarySelection, "select")
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/WeightedGenomicBinarySelection_2d_frontier.png", dpi = 250)
    pyplot.close()
