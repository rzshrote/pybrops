...
def test_class_docstring():
    assert_class_documentation(RandomRealSelection)

############################# Test concrete methods ############################
def test_init_is_concrete():
    assert_method_isconcrete(RandomRealSelection, "__init__")

def test_problem_is_concrete():
    assert_method_isconcrete(RandomRealSelection, "problem")

def test_sosolve_is_concrete():
    assert_method_isconcrete(RandomRealSelection, "sosolve")

def test_mosolve_is_concrete():
    assert_method_isconcrete(RandomRealSelection, "mosolve")

def test_select_is_concrete():
    assert_method_isconcrete(RandomRealSelection, "select")
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/RandomRealSelection_2d_frontier.png", dpi = 250)
    pyplot.close()
