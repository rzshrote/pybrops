...
def test_class_docstring():
    assert_class_documentation(WeightedGenomicRealSelection)

############################# Test concrete methods ############################
def test_init_is_concrete():
    assert_method_isconcrete(WeightedGenomicRealSelection, "__init__")

def test_problem_is_concrete():
    assert_method_isconcrete(WeightedGenomicRealSelection, "problem")

def test_sosolve_is_concrete():
    assert_method_isconcrete(WeightedGenomicRealSelection, "sosolve")

def test_mosolve_is_concrete():
    assert_method_isconcrete(WeightedGenomicRealSelection, "mosolve")

def test_select_is_concrete():
    assert_method_isconcrete(WeightedGenomicRealSelection, "select")
