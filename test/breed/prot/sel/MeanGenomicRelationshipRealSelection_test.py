...
from pybrops.breed.prot.sel.MeanGenomicRelationshipSelection import MeanGenomicRelationshipRealSelection
...
def selprot_single(
    ...
    out = MeanGenomicRelationshipRealSelection(
...
def test_mosolve(
    ...
    pyplot.savefig("frontier_plots/MeanGenomicRelationshipRealSelection_2d_frontier.png", dpi = 250)
    pyplot.close()
