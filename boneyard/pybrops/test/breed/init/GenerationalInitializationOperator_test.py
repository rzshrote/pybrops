...
# from pybrops.breed.prot.sel import ConventionalPhenotypicParentSelection
# from pybrops.breed.mate import GenerationalTwoWayDHCross
# from pybrops.breed.intg import GenerationalGenotypeIntegrationOperator
# from pybrops.breed.eval import NoGxEEvaluationOperator
# from pybrops.breed.intg import GenerationalBreedingValueIntegrationOperator
# from pybrops.breed.calibr import TrueGenomicModelCalibrationOperator
# from pybrops.breed.ssel import FamilyPhenotypicSurvivorSelection
# from pybrops.breed.init import GenerationalInitializationOperator
#
# ################################################################################
...
#     result = DensePhasedGenotypeMatrix.from_vcf(data_path)
#     result.group()
