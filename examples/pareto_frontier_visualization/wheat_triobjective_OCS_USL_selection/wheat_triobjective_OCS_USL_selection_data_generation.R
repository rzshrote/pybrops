...
write.csv(Z, gzfile("wheat_markers.csv.gz"))

# save the fixed effects to csv file
write.csv(beta_df, gzfile("wheat_intercepts.csv.gz"), row.names = FALSE)

# save the marker effects to csv file
write.csv(u_a_df, gzfile("wheat_marker_effects.csv.gz"), row.names = FALSE)
