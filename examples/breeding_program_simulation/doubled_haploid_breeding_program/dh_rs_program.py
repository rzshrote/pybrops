...
class MyLogbook(Logbook):
    ...
    def log_initialize(self, genome, geno, pheno, bval, gmod, t_cur, t_max, **kwargs):
        ...
        self.data["cand_mean"].append(bval["cand"].tmean(unscale = True)[0])
        self.data["cand_true_mean"].append(cand_bval_true.tmean(unscale = True)[0])
        self.data["cand_std"].append(bval["cand"].tstd(unscale = True)[0])
        self.data["cand_true_std"].append(cand_bval_true.tstd(unscale = True)[0])
        self.data["cand_true_var_A"].append(gpmod.var_A(genome["cand"])[0])
        self.data["cand_true_var_a"].append(gpmod.var_a(genome["cand"])[0])
        self.data["cand_true_bulmer"].append(gpmod.bulmer(genome["cand"])[0])
        self.data["cand_true_usl"].append(gpmod.usl(genome["cand"], unscale = True)[0])
        self.data["cand_true_lsl"].append(gpmod.lsl(genome["cand"], unscale = True)[0])
        self.data["main_meh"].append(genome["main"].meh())
        self.data["main_mean"].append(bval["main"].tmean(unscale = True)[0])
        self.data["main_true_mean"].append(main_bval_true.tmean(unscale = True)[0])
        self.data["main_std"].append(bval["main"].tstd(unscale = True)[0])
        self.data["main_true_std"].append(main_bval_true.tstd(unscale = True)[0])
        self.data["main_true_var_A"].append(gpmod.var_A(genome["main"])[0])
        self.data["main_true_var_a"].append(gpmod.var_a(genome["main"])[0])
        self.data["main_true_bulmer"].append(gpmod.bulmer(genome["main"])[0])
        self.data["main_true_usl"].append(gpmod.usl(genome["main"], unscale = True)[0])
        self.data["main_true_lsl"].append(gpmod.lsl(genome["main"], unscale = True)[0])
