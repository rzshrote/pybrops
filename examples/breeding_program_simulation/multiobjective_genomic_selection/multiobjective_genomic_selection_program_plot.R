...
mocgsrs_df <- read.csv("multiobjective_genomic_selection_program.csv", header = TRUE)
...
ggsave(
    "multiobjective_genomic_selection_breeding_values.png",
    mocgsrs_plot,
    width = 6,
    height = 6,
    units = "in",
...
ggsave(
    "multiobjective_genomic_selection_mean_expected_heterozygosity.png",
    mocgsrs_plot,
    width = 6,
    height = 6,
    units = "in",
