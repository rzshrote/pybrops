...
class test_MarkerAssistedSelection(unittest.TestCase):
    def test_constructor(self):
        ...
        breeding = breed.MarkerAssistedSelection(
            population,
            cross
        )

        self.assertIsInstance(breeding, breed.MarkerAssistedSelection)
