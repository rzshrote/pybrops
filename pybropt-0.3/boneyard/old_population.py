...
class population:
    ...
    chr_grp : numpy.ndarray, list-like, default = None
        ...
        chromosome groups must be strings (or convertable to strings).
    ...
    chr_pos : numpy.ndarray, list-like, default = None
        ...
        chromosome stop position of the marker (1 indexed, inclusive).
    ...
    nphase : int
        Number of chromosome phases (2 for diploids, etc.).
    ...
    def __init__(self, geno = None, coeff = None, taxa = None, chr_grp = None,
        ...
        chr_grp : numpy.ndarray, list-like, default = None
            ...
            The chromosome groups must be strings (or convertable to strings).
        ...
        chr_pos : numpy.ndarray, list-like, default = None
            ...
            the chromosome stop position of the marker (1 indexed, inclusive).
