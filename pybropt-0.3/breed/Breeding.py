...
class Breeding:
    ...
    def objfn_platypus(self, sel, **kwargs):
        """
        Objective function for cooperation with Platypus Multi-Objective
        library.
        """
        raise NotImplementedError("The method 'objfn_platypus' is abstract.")
