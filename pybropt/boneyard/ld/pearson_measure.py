...
def pearson(rsel, geno, rslice, cslice, r, cycles, dtype = None):
    """
    Calculate r (Pearson correlation coefficient) linkage disequilibrium matrix.
    ...
    # calculate r
    pearson = D / numpy.sqrt(                   # calculate sqrt(r_sq)
