class VariantMatrixInterface:
    """docstring for VariantMatrixInterface."""

    ############################################################################
    ########################## Special Object Methods ##########################
    ############################################################################
    def __init__(self, **kwargs):
        super(VariantMatrixInterface, self).__init__(**kwargs)
...
################################## Utilities ###################################
################################################################################
def is_VariantMatrixInterface(v):
    return isinstance(v, VariantMatrixInterface)

def check_is_VariantMatrixInterface(v, varname):
    if not isinstance(v, VariantMatrixInterface):
        raise TypeError("'%s' must be a VariantMatrixInterface." % varname)

def cond_check_is_VariantMatrixInterface(v, varname, cond=(lambda s: s is not None)):
    if cond(v):
        check_is_VariantMatrixInterface(v, varname)
