...
from pybropt.core.mat.DenseMatrix import check_is_DenseMatrix
from pybropt.core.mat.DenseMatrix import cond_check_is_DenseMatrix
...
def test_truediv_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__truediv__")

def test_floordiv_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__floordiv__")

def test_mod_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__mod__")

def test_divmod_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__divmod__")

def test_pow_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__pow__")

def test_lshift_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__lshift__")

def test_rshift_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rshift__")

def test_and_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__and__")

def test_xor_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__xor__")

def test_or_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__or__")

### Reverse math operators
def test_radd_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__radd__")

def test_rsub_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rsub__")

def test_rmul_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rmul__")

def test_rmatmul_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rmatmul__")

def test_rtruediv_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rtruediv__")

def test_rfloordiv_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rfloordiv__")

def test_rmod_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rmod__")

def test_rdivmod_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rdivmod__")

def test_rlshift_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rlshift__")

def test_rrshift_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rrshift__")

def test_rand_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rand__")

def test_rxor_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__rxor__")

def test_ror_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__ror__")

### Augment operators
def test_iadd_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__iadd__")

def test_isub_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__isub__")

def test_imul_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__imul__")

def test_imatmul_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__imatmul__")

def test_itruediv_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__itruediv__")

def test_ifloordiv_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__ifloordiv__")

def test_imod_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__imod__")

def test_ipow_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__ipow__")

def test_ilshift_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__ilshift__")

def test_irshift_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__irshift__")

def test_iand_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__iand__")

def test_ixor_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__ixor__")

def test_ior_is_concrete():
    generic_assert_concrete_method(DenseMatrix, "__ior__")
