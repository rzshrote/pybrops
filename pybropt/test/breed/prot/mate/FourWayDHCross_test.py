...
################################################################################
def test_mate(fourway, dpgvmat, sel, rng):
    progeny, misc = fourway.mate(dpgvmat, sel, 1, 2, s = 0)
    # print("parents:\n", dpgvmat.mat)
    # print("progeny:\n", progeny.mat)
...
def test_is_FourWayDHCross(fourway):
    assert is_FourWayDHCross(fourway)

def test_check_is_FourWayDHCross_is_concrete():
    generic_assert_concrete_function(check_is_FourWayDHCross)

def test_check_is_FourWayDHCross(fourway):
    with not_raises(TypeError):
        check_is_FourWayDHCross(fourway, "fourway")
    with pytest.raises(TypeError):
        check_is_FourWayDHCross(None, "fourway")
