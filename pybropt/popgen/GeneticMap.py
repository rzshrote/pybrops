...
class GeneticMap(MarkerSet):
    ...
    def key_to_mapfn(key):
        return key if callable(key) else GeneticMap.KEY_TO_MAPFN.get(key, None)
    ...
    KEY_TO_MAP_FNCODE = {
        ...
        "haldane": "h",
        haldane_to_r: 'h',
        haldane_to_r.__func__.__name__: 'h',

        # kosambi functions
        "kosambi": "k",
        kosambi_to_r: 'k',
        kosambi_to_r.__func__.__name__: 'k',
    ...
    KEY_TO_MAPFN = {
        # haldane keys
        "h": haldane_to_r,
        "haldane" : haldane_to_r,

        # kosambi keys
        "k": kosambi_to_r,
        "kosambi": kosambi_to_r,
    }
