"""
Module implementing dense two-way progeny mean GEBV matrices and associated error checking routines.
"""
...
class DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix(
    ...
    def __init__(
        ...
        """
        Constructor for DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix.
        
        Parameters
        ----------
        mat : numpy.ndarray
            An array of shape ``(n,n,t)`` containing progeny mean GEBVs.
    ...
    def __copy__(
        ...
        out : DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix
            A copy of the DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix.
        """
    ...
    def __deepcopy__(
        ...
        -------
        out : DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix
            A deep copy of the DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix.
        """
        return self.__class__(
    ...
    def copy(
        ...
        -------
        out : DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix
            A shallow copy of the original DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix.
        """
    ...
    def deepcopy(
        ...
        -------
        out : DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix
            A deep copy of the original DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix.
        """
...
################################## Utilities ###################################
def check_is_DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix(v: object, vname: str) -> None:
    """
    Check if an object is of type ``DenseTwoWayProgenyMeanGenomicEstimatedBreedingValueMatrix``. Otherwise raise ``TypeError``.
