...
class DenseDihybridDHAdditiveGeneticVarianceMatrix(DenseAdditiveGeneticVarianceMatrix):
    ...
    def to_pandas(
        ...
        """
        Export a DenseDihybridDHAdditiveGeneticVarianceMatrix to a pandas.DataFrame.
    ...
    def to_csv(
        ...
        """
        Write a DenseDihybridDHAdditiveGeneticVarianceMatrix to a CSV file.
        ...
        """
        # convert DenseDihybridDHAdditiveGeneticVarianceMatrix to pandas.DataFrame
        df = self.to_pandas(
    ...
    def from_pandas(
        ...
        """
        Read a ``DenseDihybridDHAdditiveGeneticVarianceMatrix`` from a ``pandas.DataFrame``.
        ...
        out : DenseDihybridDHAdditiveGeneticVarianceMatrix
            A ``DenseDihybridDHAdditiveGeneticVarianceMatrix`` read from a ``pandas.DataFrame``.
        """
