...
from pybrops.opt.soln.DenseSubsetSolution import DenseSubsetSolution, check_is_DenseSubsetSolution
...
def test_DenseSubsetSolution_docstring():
    assert_docstring(DenseSubsetSolution)
...
def test_decn_space_is_concrete():
    assert_concrete_property(DenseSubsetSolution, "decn_space")
...
def test_init_is_concrete():
    assert_concrete_method(DenseSubsetSolution, "__init__")
...
def test_check_is_DenseSubsetSolution_is_concrete():
    assert_concrete_function(check_is_DenseSubsetSolution)

def test_check_is_DenseSubsetSolution(prob):
    with not_raises(TypeError):
        check_is_DenseSubsetSolution(prob, "prob")
    with pytest.raises(TypeError):
        check_is_DenseSubsetSolution(None, "prob")
