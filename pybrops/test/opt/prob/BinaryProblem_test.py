...
class BinaryProblemTestClass(BinaryProblem):
    ...
    def evalfn(self, x, *args, **kwargs):
        """NA"""
        super(BinaryProblemTestClass, self).evalfn(x, *args, **kwargs)
    ### method required by PyMOO interface ###
    def _evaluate(self, x, out, *args, **kwargs):
        """NA"""
        super(BinaryProblemTestClass, self)._evaluate(x, out, *args, **kwargs)
...
def test_BinaryProblem_docstring():
    assert_docstring(BinaryProblem)
...
def test_decn_space_is_concrete():
    assert_concrete_property(BinaryProblem, "decn_space")
...
def test_init_is_concrete():
    assert_concrete_method(BinaryProblem, "__init__")
...
def test_check_is_BinaryProblem_is_concrete():
    assert_concrete_function(check_is_BinaryProblem)
