...
def test_add_is_abstract(mat):
    assert_abstract_method(mat, "__add__")

def test_sub_is_abstract(mat):
    assert_abstract_method(mat, "__sub__")

def test_mul_is_abstract(mat):
    assert_abstract_method(mat, "__mul__")

def test_matmul_is_abstract(mat):
    assert_abstract_method(mat, "__matmul__")

def test_truediv_is_abstract(mat):
    assert_abstract_method(mat, "__truediv__")

def test_floordiv_is_abstract(mat):
    assert_abstract_method(mat, "__floordiv__")

def test_mod_is_abstract(mat):
    assert_abstract_method(mat, "__mod__")

def test_divmod_is_abstract(mat):
    assert_abstract_method(mat, "__divmod__")

def test_pow_is_abstract(mat):
    assert_abstract_method(mat, "__pow__")

def test_lshift_is_abstract(mat):
    assert_abstract_method(mat, "__lshift__")

def test_rshift_is_abstract(mat):
    assert_abstract_method(mat, "__rshift__")

def test_and_is_abstract(mat):
    assert_abstract_method(mat, "__and__")

def test_xor_is_abstract(mat):
    assert_abstract_method(mat, "__xor__")

def test_or_is_abstract(mat):
    assert_abstract_method(mat, "__or__")

def test_rand_is_abstract(mat):
    assert_abstract_method(mat, "__rand__")

def test_rsub_is_abstract(mat):
    assert_abstract_method(mat, "__rsub__")

def test_rmul_is_abstract(mat):
    assert_abstract_method(mat, "__rmul__")

def test_rmatmul_is_abstract(mat):
    assert_abstract_method(mat, "__rmatmul__")

def test_rtruediv_is_abstract(mat):
    assert_abstract_method(mat, "__rtruediv__")

def test_rfloordiv_is_abstract(mat):
    assert_abstract_method(mat, "__rfloordiv__")

def test_rmod_is_abstract(mat):
    assert_abstract_method(mat, "__rmod__")

def test_rlshift_is_abstract(mat):
    assert_abstract_method(mat, "__rlshift__")

def test_rrshift_is_abstract(mat):
    assert_abstract_method(mat, "__rrshift__")

def test_rand_is_abstract(mat):
    assert_abstract_method(mat, "__rand__")

def test_rxor_is_abstract(mat):
    assert_abstract_method(mat, "__rxor__")

def test_ror_is_abstract(mat):
    assert_abstract_method(mat, "__ror__")

def test_iadd_is_abstract(mat):
    assert_abstract_method(mat, "__iadd__")

def test_isub_is_abstract(mat):
    assert_abstract_method(mat, "__isub__")

def test_imul_is_abstract(mat):
    assert_abstract_method(mat, "__imul__")

def test_imatmul_is_abstract(mat):
    assert_abstract_method(mat, "__imatmul__")

def test_itruediv_is_abstract(mat):
    assert_abstract_method(mat, "__itruediv__")

def test_ifloordiv_is_abstract(mat):
    assert_abstract_method(mat, "__ifloordiv__")

def test_imod_is_abstract(mat):
    assert_abstract_method(mat, "__imod__")

def test_ipow_is_abstract(mat):
    assert_abstract_method(mat, "__ipow__")

def test_ilshift_is_abstract(mat):
    assert_abstract_method(mat, "__ilshift__")

def test_irshift_is_abstract(mat):
    assert_abstract_method(mat, "__irshift__")

def test_iand_is_abstract(mat):
    assert_abstract_method(mat, "__iand__")

def test_ixor_is_abstract(mat):
    assert_abstract_method(mat, "__ixor__")

def test_ior_is_abstract(mat):
    assert_abstract_method(mat, "__ior__")

def test_lt_is_abstract(mat):
    assert_abstract_method(mat, "__lt__")

def test_le_is_abstract(mat):
    assert_abstract_method(mat, "__le__")

def test_eq_is_abstract(mat):
    assert_abstract_method(mat, "__eq__")

def test_ne_is_abstract(mat):
    assert_abstract_method(mat, "__ne__")

def test_gt_is_abstract(mat):
    assert_abstract_method(mat, "__gt__")

def test_ge_is_abstract(mat):
    assert_abstract_method(mat, "__ge__")

def test_len_is_abstract(mat):
    assert_abstract_method(mat, "__len__")

def test_getitem_is_abstract(mat):
    assert_abstract_method(mat, "__getitem__")

def test_delitem_is_abstract(mat):
    assert_abstract_method(mat, "__delitem__")

def test_iter_is_abstract(mat):
    assert_abstract_method(mat, "__iter__")

def test_copy_is_abstract(mat):
    assert_abstract_method(mat, "__copy__")
    assert_abstract_method(mat, "copy")

def test_deepcopy_is_abstract(mat):
    assert_abstract_method(mat, "__deepcopy__")
    assert_abstract_method(mat, "deepcopy")

def test_adjoin_is_abstract(mat):
    assert_abstract_method(mat, "adjoin")

def test_delete_is_abstract(mat):
    assert_abstract_method(mat, "delete")

def test_insert_is_abstract(mat):
    assert_abstract_method(mat, "insert")

def test_select_is_abstract(mat):
    assert_abstract_method(mat, "select")

def test_concat_is_abstract(mat):
    assert_abstract_method(mat, "concat")
