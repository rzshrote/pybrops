...
def test_class_docstring():
    assert_docstring(RandomIntegerSelection)

############################# Test concrete methods ############################
def test_init_is_concrete():
    assert_concrete_method(RandomIntegerSelection, "__init__")

def test_problem_is_concrete():
    assert_concrete_method(RandomIntegerSelection, "problem")

def test_sosolve_is_concrete():
    assert_concrete_method(RandomIntegerSelection, "sosolve")

def test_mosolve_is_concrete():
    assert_concrete_method(RandomIntegerSelection, "mosolve")

def test_select_is_concrete():
    assert_concrete_method(RandomIntegerSelection, "select")
