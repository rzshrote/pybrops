...
def test_class_docstring():
    assert_docstring(RandomRealSelection)

############################# Test concrete methods ############################
def test_init_is_concrete():
    assert_concrete_method(RandomRealSelection, "__init__")

def test_problem_is_concrete():
    assert_concrete_method(RandomRealSelection, "problem")

def test_sosolve_is_concrete():
    assert_concrete_method(RandomRealSelection, "sosolve")

def test_mosolve_is_concrete():
    assert_concrete_method(RandomRealSelection, "mosolve")

def test_select_is_concrete():
    assert_concrete_method(RandomRealSelection, "select")
