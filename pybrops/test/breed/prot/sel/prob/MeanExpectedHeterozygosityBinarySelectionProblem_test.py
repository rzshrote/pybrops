...
def test_BinaryConventionalSelectionProblem_docstring():
    assert_docstring(MeanExpectedHeterozygosityBinarySelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(MeanExpectedHeterozygosityBinarySelectionProblem, "nlatent")
...
def test_C_is_concrete():
    assert_concrete_property(MeanExpectedHeterozygosityBinarySelectionProblem, "C")
...
def test_init_is_concrete():
    assert_concrete_method(MeanExpectedHeterozygosityBinarySelectionProblem, "__init__")
