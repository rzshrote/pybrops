...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_docstring(OptimalContributionIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(OptimalContributionIntegerSelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_concrete_property(OptimalContributionIntegerSelectionProblem, "ebv")
...
def test_C_is_concrete():
    assert_concrete_property(OptimalContributionIntegerSelectionProblem, "C")
...
def test_init_is_concrete():
    assert_concrete_method(OptimalContributionIntegerSelectionProblem, "__init__")
