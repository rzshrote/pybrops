...
def test_BinaryConventionalSelectionProblem_docstring():
    assert_docstring(L2NormGenomicBinarySelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(L2NormGenomicBinarySelectionProblem, "nlatent")
...
def test_C_is_concrete():
    assert_concrete_property(L2NormGenomicBinarySelectionProblem, "C")
...
def test_init_is_concrete():
    assert_concrete_method(L2NormGenomicBinarySelectionProblem, "__init__")
