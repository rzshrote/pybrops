...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_docstring(FamilyEstimatedBreedingValueIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(FamilyEstimatedBreedingValueIntegerSelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_concrete_property(FamilyEstimatedBreedingValueIntegerSelectionProblem, "ebv")
...
def test_init_is_concrete():
    assert_concrete_method(FamilyEstimatedBreedingValueIntegerSelectionProblem, "__init__")
