...
def test_RealConventionalSelectionProblem_docstring():
    assert_docstring(MeanGenomicRelationshipRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(MeanGenomicRelationshipRealSelectionProblem, "nlatent")
...
def test_C_is_concrete():
    assert_concrete_property(MeanGenomicRelationshipRealSelectionProblem, "C")
...
def test_init_is_concrete():
    assert_concrete_method(MeanGenomicRelationshipRealSelectionProblem, "__init__")
