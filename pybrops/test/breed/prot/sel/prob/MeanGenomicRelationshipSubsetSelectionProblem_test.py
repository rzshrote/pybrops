...
def test_SubsetConventionalSelectionProblem_docstring():
    assert_docstring(MeanGenomicRelationshipSubsetSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(MeanGenomicRelationshipSubsetSelectionProblem, "nlatent")
...
def test_C_is_concrete():
    assert_concrete_property(MeanGenomicRelationshipSubsetSelectionProblem, "C")
...
def test_init_is_concrete():
    assert_concrete_method(MeanGenomicRelationshipSubsetSelectionProblem, "__init__")
