...
def test_SubsetConventionalSelectionProblem_docstring():
    assert_docstring(MeanExpectedHeterozygositySubsetSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(MeanExpectedHeterozygositySubsetSelectionProblem, "nlatent")
...
def test_C_is_concrete():
    assert_concrete_property(MeanExpectedHeterozygositySubsetSelectionProblem, "C")
...
def test_init_is_concrete():
    assert_concrete_method(MeanExpectedHeterozygositySubsetSelectionProblem, "__init__")
