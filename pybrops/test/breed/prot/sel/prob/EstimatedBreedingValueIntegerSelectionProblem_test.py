...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_docstring(EstimatedBreedingValueIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(EstimatedBreedingValueIntegerSelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_concrete_property(EstimatedBreedingValueIntegerSelectionProblem, "ebv")
...
def test_init_is_concrete():
    assert_concrete_method(EstimatedBreedingValueIntegerSelectionProblem, "__init__")
