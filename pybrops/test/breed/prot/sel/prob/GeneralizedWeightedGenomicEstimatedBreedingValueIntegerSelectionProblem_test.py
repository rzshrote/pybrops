...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_docstring(GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem, "nlatent")
...
def test_gwgebv_is_concrete():
    assert_concrete_property(GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem, "gwgebv")
...
def test_init_is_concrete():
    assert_concrete_method(GeneralizedWeightedGenomicEstimatedBreedingValueIntegerSelectionProblem, "__init__")
