...
def prob(
    ...
    yield UsefulnessCriterionIntegerSelectionProblem(
        ucmat = ucmat,
        ndecn = ndecn,
...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_docstring(UsefulnessCriterionIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(UsefulnessCriterionIntegerSelectionProblem, "nlatent")
...
def test_ucmat_is_concrete():
    assert_concrete_property(UsefulnessCriterionIntegerSelectionProblem, "ucmat")
...
def test_init_is_concrete():
    assert_concrete_method(UsefulnessCriterionIntegerSelectionProblem, "__init__")
...
def test_from_pgmat_gpmod(
    ...
    # construct problem
    ohvprob = UsefulnessCriterionIntegerSelectionProblem.from_pgmat_gpmod(
        nparent, ncross, nprogeny, nself, upper_percentile, vmatfcty, gmapfn, unique_parents, pgmat, gpmod,
        ndecn, decn_space, decn_space_lower, decn_space_upper, 
        nobj, obj_wt, obj_trans, obj_trans_kwargs, 
        nineqcv, ineqcv_wt, ineqcv_trans, ineqcv_trans_kwargs, 
