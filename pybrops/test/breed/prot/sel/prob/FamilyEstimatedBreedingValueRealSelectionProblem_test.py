...
def test_RealConventionalSelectionProblem_docstring():
    assert_docstring(FamilyEstimatedBreedingValueRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(FamilyEstimatedBreedingValueRealSelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_concrete_property(FamilyEstimatedBreedingValueRealSelectionProblem, "ebv")
...
def test_init_is_concrete():
    assert_concrete_method(FamilyEstimatedBreedingValueRealSelectionProblem, "__init__")
