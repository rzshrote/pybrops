...
def test_BinaryConventionalSelectionProblem_docstring():
    assert_docstring(GeneralizedWeightedGenomicEstimatedBreedingValueBinarySelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(GeneralizedWeightedGenomicEstimatedBreedingValueBinarySelectionProblem, "nlatent")
...
def test_gwgebv_is_concrete():
    assert_concrete_property(GeneralizedWeightedGenomicEstimatedBreedingValueBinarySelectionProblem, "gwgebv")
...
def test_init_is_concrete():
    assert_concrete_method(GeneralizedWeightedGenomicEstimatedBreedingValueBinarySelectionProblem, "__init__")
