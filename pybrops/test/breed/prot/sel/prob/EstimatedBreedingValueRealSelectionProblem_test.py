...
def test_RealConventionalSelectionProblem_docstring():
    assert_docstring(EstimatedBreedingValueRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(EstimatedBreedingValueRealSelectionProblem, "nlatent")
...
def test_ebv_is_concrete():
    assert_concrete_property(EstimatedBreedingValueRealSelectionProblem, "ebv")
...
def test_init_is_concrete():
    assert_concrete_method(EstimatedBreedingValueRealSelectionProblem, "__init__")
