...
def test_RealConventionalSelectionProblem_docstring():
    assert_docstring(MeanExpectedHeterozygosityRealSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(MeanExpectedHeterozygosityRealSelectionProblem, "nlatent")
...
def test_C_is_concrete():
    assert_concrete_property(MeanExpectedHeterozygosityRealSelectionProblem, "C")
...
def test_init_is_concrete():
    assert_concrete_method(MeanExpectedHeterozygosityRealSelectionProblem, "__init__")
