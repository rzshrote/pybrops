...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_docstring(WeightedGenomicIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(WeightedGenomicIntegerSelectionProblem, "nlatent")
...
def test_gwgebv_is_concrete():
    assert_concrete_property(WeightedGenomicIntegerSelectionProblem, "gwgebv")
...
def test_init_is_concrete():
    assert_concrete_method(WeightedGenomicIntegerSelectionProblem, "__init__")
