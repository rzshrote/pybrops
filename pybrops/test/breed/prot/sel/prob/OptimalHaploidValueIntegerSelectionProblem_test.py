...
def test_IntegerConventionalSelectionProblem_docstring():
    assert_docstring(OptimalHaploidValueIntegerSelectionProblem)
...
def test_nlatent_is_concrete():
    assert_concrete_property_fget(OptimalHaploidValueIntegerSelectionProblem, "nlatent")
...
def test_ohvmat_is_concrete():
    assert_concrete_property(OptimalHaploidValueIntegerSelectionProblem, "ohvmat")
...
def test_init_is_concrete():
    assert_concrete_method(OptimalHaploidValueIntegerSelectionProblem, "__init__")
