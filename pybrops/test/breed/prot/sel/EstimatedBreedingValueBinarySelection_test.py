...
def test_pareto_is_concrete():
    assert_concrete_method(EstimatedBreedingValueBinarySelection, "pareto")
...
def test_problem(selprot, pgmat, gmat, bvmat, algmod):
    ...
    assert isinstance(prob, EstimatedBreedingValueBinarySelectionProblem)
...
def test_pareto(selprot, pgmat, gmat, bvmat, algmod):
    ...
    pyplot.savefig("EBV_Binary_2d_frontier.png", dpi = 250)

    print(sel_config.astype(int))
    assert False
