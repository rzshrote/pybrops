...
def selsoln(
    ...
    out = DummySubsetSelectionProtocol(
...
def test_check_is_SubsetSelectionProtocol(selsoln):
    with not_raises(Exception):
        check_is_SubsetSelectionProtocol(selsoln, "selsoln")
    with pytest.raises(TypeError):
        check_is_SubsetSelectionProtocol(object(), "selsoln")
    with pytest.raises(TypeError):
        check_is_SubsetSelectionProtocol(None, "selsoln")
