...
def test_class_docstring():
    assert_docstring(WeightedGenomicBinarySelection)

############################# Test concrete methods ############################
def test_init_is_concrete():
    assert_concrete_method(WeightedGenomicBinarySelection, "__init__")

def test_problem_is_concrete():
    assert_concrete_method(WeightedGenomicBinarySelection, "problem")

def test_sosolve_is_concrete():
    assert_concrete_method(WeightedGenomicBinarySelection, "sosolve")

def test_mosolve_is_concrete():
    assert_concrete_method(WeightedGenomicBinarySelection, "mosolve")

def test_select_is_concrete():
    assert_concrete_method(WeightedGenomicBinarySelection, "select")
