...
def test_class_docstring():
    generic_assert_docstring(Logbook)

################################################################################
############################# Test concrete methods ############################
################################################################################
def test_init_is_concrete():
    generic_assert_concrete_method(Logbook, "__init__")

################################################################################
########################### Test abstract properties ###########################
################################################################################
def test_data_is_abstract():
    generic_assert_abstract_property(Logbook, "data")

def test_rep_is_abstract():
    generic_assert_abstract_property(Logbook, "rep")

################################################################################
############################# Test abstract methods ############################
################################################################################
def test_log_initialize_is_abstract():
    generic_assert_abstract_method(Logbook, "log_initialize")

def test_log_pselect_is_abstract():
    generic_assert_abstract_method(Logbook, "log_pselect")

def test_log_mate_is_abstract():
    generic_assert_abstract_method(Logbook, "log_mate")

def test_log_evaluate_is_abstract():
    generic_assert_abstract_method(Logbook, "log_evaluate")

def test_log_sselect_is_abstract():
    generic_assert_abstract_method(Logbook, "log_sselect")

def test_reset_is_abstract():
    generic_assert_abstract_method(Logbook, "reset")

def test_write_is_abstract():
    generic_assert_abstract_method(Logbook, "write")

################################################################################
################### Test for conrete class utility functions ###################
################################################################################
def test_is_Logbook_is_concrete():
    generic_assert_concrete_function(is_Logbook)
