...
from pybrops.core.error.error_value_numpy import check_ndarray_is_1d, check_ndarray_is_2d, check_ndarray_len_eq, check_ndarray_len_gteq, check_ndarray_shape_eq
from pybrops.core.error.error_value_python import check_is_gteq
from pybrops.opt.soln.SetSolution import SetSolution

class DenseSetSolution(SetSolution):
    """
    ...
    def __init__(
        ...
        """
        super(DenseSetSolution, self).__init__(**kwargs)
