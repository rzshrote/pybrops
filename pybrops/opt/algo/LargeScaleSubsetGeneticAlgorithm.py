...
from pybrops.opt.algo.pymoo_addon_large_scale import TiledReducedExchangeMutation, TiledSubsetPoolIterator, TiledSubsetRandomSampling
...
class LargeScaleSubsetGeneticAlgorithm(
    ...
    def minimize(
        ...
        sampling = TiledSubsetRandomSampling(tspiter = it)

        # construct crossover operator
        crossover = ReducedExchangeCrossover()

        # construct mutation operator
        mutation = TiledReducedExchangeMutation(tspiter = it)
