...
class UnconstrainedSteepestAscentSetGeneticAlgorithm(UnconstrainedOptimizationAlgorithm):
    """
    ...
    def __init__(self, ngen = 250, mu = 100, lamb = 100, M = 1.5, meme = 1, rng = global_prng, **kwargs: dict):
        ...
        """
        super(UnconstrainedSteepestAscentSetGeneticAlgorithm, self).__init__(**kwargs)
        self.ngen = ngen
        self.mu = mu
        self.lamb = lamb
        self.M = M
