...
__all__ = [
    "MeanGenomicRelationshipBaseSelection",
...
class MeanGenomicRelationshipBaseSelection(SelectionProtocol,metaclass=ABCMeta):
    """
    ...
    def __init__(
        ...
        """
        super(MeanGenomicRelationshipBaseSelection, self).__init__(
            method = method,
            nobj = nobj,
            obj_wt = obj_wt,
            obj_trans = obj_trans,
...
class MeanGenomicRelationshipSubsetSelection(MeanGenomicRelationshipBaseSelection):
    """
...
class MeanGenomicRelationshipRealSelection(MeanGenomicRelationshipBaseSelection):
    """
...
class MeanGenomicRelationshipIntegerSelection(MeanGenomicRelationshipBaseSelection):
    """
...
class MeanGenomicRelationshipBinarySelection(MeanGenomicRelationshipBaseSelection):
    """
    Conventional Genomic Selection in a subset search space.
    """
    ############################################################################
