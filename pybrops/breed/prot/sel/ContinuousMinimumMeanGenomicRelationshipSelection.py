...
class ContinuousMinimumMeanGenomicRelationshipSelection(SelectionProtocol):
    ...
    def __init__(
            ...
            nprogeny: int,
            gtype: str = "gmat", 
            gcls = DenseVanRadenCoancestryMatrix, 
            method: str = "single",
            objfn_trans = None, 
        ...
        """
        super(ContinuousMinimumMeanGenomicRelationshipSelection, self).__init__(**kwargs)
    ...
    def pareto(self, pgmat, gmat, ptdf, bvmat, gpmod, t_cur, t_max, miscout = None, **kwargs: dict):
        ...
        """
        raise RuntimeError("ContinuousMinimumMeanGenomicRelationshipSelection is single objective")
