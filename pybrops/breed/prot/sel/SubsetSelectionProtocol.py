...
class SubsetSelectionProtocol(
    ...
    def __init__(
        ...
        """
        Constructor for the semi-abstract class SubsetSelectionProtocol.
        ...
        super(SubsetSelectionProtocol, self).__init__(
            ncross = ncross,
            nparent = nparent,
            nmating = nmating,
            nprogeny = nprogeny,
    ...
    def sosolve(
        ...
        # this has the exact same metadata as a SubsetSolution
        out = SubsetSelectionSolution(
            ndecn = soln.ndecn,
