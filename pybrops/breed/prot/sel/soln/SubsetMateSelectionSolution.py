...
class SubsetMateSelectionSolution(SubsetSelectionSolution,MateSelectionSolution):
    ...
    def __init__(
        ...
        """
        super(SubsetMateSelectionSolution, self).__init__(
            ndecn = ndecn,
...
################################## Utilities ###################################
def check_is_SubsetMateSelectionSolution(v: object, vname: str) -> None:
    """
    ...
    """
    if not isinstance(v, SubsetMateSelectionSolution):
        raise TypeError("variable '{0}' must be of type '{1}' but received type '{2}'".format(vname,SubsetMateSelectionSolution.__name__,type(v).__name__))
