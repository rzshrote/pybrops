...
class ContinuousMaximumMeanExpectedHeterozygositySelection(UnconstrainedSelectionProtocol):
    """
    ...
    def ktype(self) -> str:
        ...
        return self._ktype
    @ktype.setter
    def ktype(self, value: str) -> None:
        """Set kinship matrix type."""
