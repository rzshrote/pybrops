...
__all__ = [
    "ConstrainedSelectionProtocolType",
    "check_is_ConstrainedSelectionProtocolType"
]
...
class ConstrainedSelectionProtocolType:
    """
    ...
    def __init__(
        ...
        """
        Constructor for the abstract class ConstrainedSelectionProtocolType.
        ...
        """
        super(ConstrainedSelectionProtocolType, self).__init__()
...
################################## Utilities ###################################
################################################################################
def check_is_ConstrainedSelectionProtocolType(v: object, vname: str) -> None:
    """
    Check if object is of type ConstrainedSelectionProtocolType, otherwise raise TypeError.
    ...
    """
    if not isinstance(v, ConstrainedSelectionProtocolType):
        raise TypeError("'{0}' must be of type ConstrainedSelectionProtocolType.".format(vname))
