...
class RealMateSelectionProtocol(RealSelectionProtocol,MateSelectionProtocol,metaclass=ABCMeta):
    ...
    ############################ Object Properties #############################
    # inherit properties from RealSelectionProtocol
    ...
    def sosolve(
        ...
        # add cross map metadata from problem to metadata from RealSolution
    ...
    def select(
        ...
        if self.nobj == 1:
            ...
            # construct a RealMateSelectionConfiguration
            selcfg = RealMateSelectionConfiguration(
                ncross = self.ncross,
