...
class IntegerSelectionProtocol(SelectionProtocol,metaclass=ABCMeta):
    ...
    def __init__(
        ...
        """
        Constructor for the semi-abstract class IntegerSelectionProtocol.
        ...
        super(IntegerSelectionProtocol, self).__init__(
            ncross = ncross,
            nparent = nparent,
            nmating = nmating,
            nprogeny = nprogeny,
...
################################## Utilities ###################################
def check_is_IntegerSelectionProtocol(v: object, vname: str) -> None:
    """
    Check if object is of type IntegerSelectionProtocol, otherwise raise TypeError.
    ...
    """
    if not isinstance(v, IntegerSelectionProtocol):
        raise TypeError("variable '{0}' must be of type '{1}' but received type '{2}'".format(vname,IntegerSelectionProtocol.__name__,type(v).__name__))
