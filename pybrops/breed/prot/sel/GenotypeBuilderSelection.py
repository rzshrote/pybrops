...
class GenotypeBuilderBaseSelection(SelectionProtocol,metaclass=ABCMeta):
    ...
    def __init__(
        ...
        """
        super(GenotypeBuilderBaseSelection, self).__init__(
            method = method,
            nobj = nobj,
            obj_wt = obj_wt,
            obj_trans = obj_trans,
...
class GenotypeBuilderSubsetSelection(GenotypeBuilderBaseSelection):
    """
    Class defining Genotype Builder (GB) Selection for subset search spaces.
    """

    ########################## Special Object Methods ##########################
    # __init__() inherited from GenotypeBuilderBaseSelection
    ...
    ############## Pareto Frontier Functions ###############
    # pareto() inherited from GenotypeBuilderBaseSelection

    ################# Selection Functions ##################
    # select() inherited from GenotypeBuilderBaseSelection
