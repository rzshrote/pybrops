...
class TwoWayParentalMeanEstimatedBreedingValueSelectionMixin(
        metaclass = ABCMeta,
    ):
    """
...
class TwoWayParentalMeanEstimatedBreedingValueSubsetSelection(
    ...
    def __init__(
        ...
        """
        Constructor for the concrete class ParentalMeanEstimatedBreedingValueSubsetSelection.
        ...
        super(TwoWayParentalMeanEstimatedBreedingValueSubsetSelection, self).__init__(
            ncross = ncross,
            nparent = nparent,
            nmating = nmating,
            nprogeny = nprogeny,
    ...
    def problem(
        ...
        xmap = TwoWayParentalMeanEstimatedBreedingValueSubsetMateSelectionProblem._calc_xmap(
            ntaxa = ntaxa,
            symab = self.symab,
            mateab = self.mateab,
        )
        ...
        # construct problem
        prob = TwoWayParentalMeanEstimatedBreedingValueSubsetMateSelectionProblem.from_bvmat_xmap(
            bvmat = bvmat,
            xmap = xmap,
