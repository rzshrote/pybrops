...
class MeanGenomicRelationshipSelectionProblem(SelectionProblem,metaclass=ABCMeta):
    ...
    def __init__(
        ...
        """
        Constructor for MeanGenomicRelationshipSelectionProblem

        Parameters
        ----------
        C : numpy.ndarray
            An upper triangle matrix of shape (n,n) resulting from a Cholesky 
            decomposition of a genomic relationship matrix: K = C'C.
        ...
        """
        super(MeanGenomicRelationshipSelectionProblem, self).__init__(
            ndecn = ndecn,
    ...
    def C(self) -> numpy.ndarray:
        """Cholesky decomposition of the genomic relationship matrix."""
        return self._C
    @C.setter
    def C(self, value: numpy.ndarray) -> None:
        """Set Cholesky decomposition of the genomic relationship matrix."""
...
class MeanGenomicRelationshipSubsetSelectionProblem(SubsetSelectionProblem,MeanGenomicRelationshipSelectionProblem):
    """
    ...
    def latentfn(
        ...
        """
        Score a subset of individuals based according to its mean genomic 
        relationship (MGR).
        
        A smaller value indicates a better MGR score.
        ...
        # calculate MGR
        # norm2( (n,) ) -> (1,)
        out = numpy.linalg.norm(Cx, ord = 2, keepdims = True)

        return out

class MeanGenomicRelationshipRealSelectionProblem(RealSelectionProblem,MeanGenomicRelationshipSelectionProblem):
    """
    ...
    def latentfn(
        ...
        # norm( (n,) ) -> (1,)
        # scalar - (1,) -> (1,)
        out = numpy.linalg.norm(self._C.dot(contrib), ord = 2, keepdims = True)

        return out

class MeanGenomicRelationshipIntegerSelectionProblem(IntegerSelectionProblem,MeanGenomicRelationshipSelectionProblem):
    """
...
class MeanGenomicRelationshipBinarySelectionProblem(BinarySelectionProblem,MeanGenomicRelationshipSelectionProblem):
    """
    Class representing Mean Expected Heterozygosity (MEH) selection problems in integer search spaces.
    """
