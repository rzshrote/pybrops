...
class EstimatedBreedingValueSelectionProblem(SelectionProblem,metaclass=ABCMeta):
    ...
    def __init__(
        ...
        """
        Constructor for EstimatedBreedingValueSelectionProblem.
        ...
        """
        super(EstimatedBreedingValueSelectionProblem, self).__init__(
            ndecn = ndecn,
...
class EstimatedBreedingValueSubsetSelectionProblem(SubsetSelectionProblem,EstimatedBreedingValueSelectionProblem):
    ...
    ##################### GEBV matrix ######################
    @EstimatedBreedingValueSelectionProblem.ebv.setter
    def ebv(self, value: numpy.ndarray) -> None:
        """Set genomic estimated breeding values."""
        check_is_ndarray(value, "ebv")
        check_ndarray_ndim(value, "ebv", 2)
