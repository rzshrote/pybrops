...
class GenomicEstimatedBreedingValueSelectionProblem(SelectionProblem,metaclass=ABCMeta):
    ...
    def __init__(
        ...
        """
        super(GenomicEstimatedBreedingValueSelectionProblem, self).__init__(
            ndecn = ndecn,
...
class GenomicEstimatedBreedingValueSubsetSelectionProblem(SubsetSelectionProblem,GenomicEstimatedBreedingValueSelectionProblem):
    ...
    ##################### GEBV matrix ######################
    @GenomicEstimatedBreedingValueSelectionProblem.gebv.setter
    def gebv(self, value: numpy.ndarray) -> None:
        """Set genomic estimated breeding values."""
        check_is_ndarray(value, "gebv")
        check_ndarray_ndim(value, "gebv", 2)
...
class GenomicEstimatedBreedingValueIntegerSelectionProblem(IntegerSelectionProblem,GenomicEstimatedBreedingValueSelectionProblem):
    """
...
class GenomicEstimatedBreedingValueBinarySelectionProblem(BinarySelectionProblem,GenomicEstimatedBreedingValueSelectionProblem):
    """
