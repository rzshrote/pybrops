...
class SubsetOptimalContributionSelectionProblem(DenseSubsetSelectionProblem,OptimalContributionSelectionProblemProperties):
    """
...
class RealOptimalContributionSelectionProblem(DenseRealSelectionProblem,OptimalContributionSelectionProblemProperties):
    """
    Class representing an Optimal Contribution Selection Problem for subset
    search spaces.
    """
