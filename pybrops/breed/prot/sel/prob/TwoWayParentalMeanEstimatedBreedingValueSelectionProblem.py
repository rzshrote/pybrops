...
class TwoWayParentalMeanEstimatedBreedingValueProblemMixin(
        metaclass = ABCMeta,
    ):
    ...
    def from_bvmat_xmap(
            ...
            **kwargs: dict
        ) -> "TwoWayParentalMeanEstimatedBreedingValueProblemMixin":
...
class TwoWayParentalMeanEstimatedBreedingValueSubsetMateSelectionProblem(
        TwoWayParentalMeanEstimatedBreedingValueProblemMixin,
    ...
    def __init__(
        ...
        """
        super(TwoWayParentalMeanEstimatedBreedingValueSubsetMateSelectionProblem, self).__init__(
            ndecn = ndecn,
    ...
    def from_bvmat_xmap(
        ...
        tmp = DenseTwoWayParentalMeanEstimatedBreedingValueMatrix.from_bvmat(
            bvmat = bvmat,
        )
