...
class MeanExpectedHeterozygositySubsetSelection(MeanExpectedHeterozygositySelectionMixin,SubsetSelectionProtocol):
    ...
    def __init__(
        ...
        super(MeanExpectedHeterozygositySubsetSelection, self).__init__(
            ncross = ncross,
            nparent = nparent,
            nmating = nmating,
            nprogeny = nprogeny,
...
class MeanExpectedHeterozygosityRealSelection(MeanExpectedHeterozygositySelectionMixin,RealSelectionProtocol):
    ...
    def __init__(
        ...
        super(MeanExpectedHeterozygosityRealSelection, self).__init__(
            ncross = ncross,
            nparent = nparent,
            nmating = nmating,
            nprogeny = nprogeny,
...
class MeanExpectedHeterozygosityIntegerSelection(MeanExpectedHeterozygositySelectionMixin,IntegerSelectionProtocol):
    ...
    def __init__(
        ...
        super(MeanExpectedHeterozygosityIntegerSelection, self).__init__(
            ncross = ncross,
            nparent = nparent,
            nmating = nmating,
            nprogeny = nprogeny,
...
class MeanExpectedHeterozygosityBinarySelection(MeanExpectedHeterozygositySelectionMixin,BinarySelectionProtocol):
    ...
    def __init__(
        ...
        super(MeanExpectedHeterozygosityBinarySelection, self).__init__(
            ncross = ncross,
            nparent = nparent,
            nmating = nmating,
            nprogeny = nprogeny,
