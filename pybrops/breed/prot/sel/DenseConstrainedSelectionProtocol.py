...
__all__ = [
    "DenseConstrainedSelectionProtocol"
]
...
class DenseConstrainedSelectionProtocol(ConstrainedSelectionProtocol):
    """
    ...
    def __init__(
        ...
        """
        Constructor for the abstract class DenseConstrainedSelectionProtocol.
        ...
        """
        super(DenseConstrainedSelectionProtocol, self).__init__(**kwargs)
