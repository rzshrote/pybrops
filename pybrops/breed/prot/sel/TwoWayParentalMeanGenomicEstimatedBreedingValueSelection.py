...
class TwoWayParentalMeanGenomicEstimatedBreedingValueSelectionMixin(
        metaclass = ABCMeta,
    ):
    """
...
class TwoWayParentalMeanGenomicEstimatedBreedingValueSubsetSelection(
        TwoWayParentalMeanGenomicEstimatedBreedingValueSelectionMixin,
    ...
    def __init__(
        ...
        """
        Constructor for the concrete class ParentalMeanGenomicEstimatedBreedingValueSubsetSelection.
        ...
        super(TwoWayParentalMeanGenomicEstimatedBreedingValueSubsetSelection, self).__init__(
            ncross = ncross,
            nparent = nparent,
            nmating = nmating,
            nprogeny = nprogeny,
    ...
    def problem(
        ...
        xmap = TwoWayParentalMeanGenomicEstimatedBreedingValueSubsetMateSelectionProblem._calc_xmap(
            ntaxa = ntaxa,
            symab = self.symab,
            mateab = self.mateab,
        )
        ...
        # construct problem
        prob = TwoWayParentalMeanGenomicEstimatedBreedingValueSubsetMateSelectionProblem.from_gmat_gpmod_xmap(
            gmat = gmat,
            gpmod = gpmod,
            xmap = xmap,
